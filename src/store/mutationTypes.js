...
// export const THE_SEARCH_KEY = 'THE_SEARCH_KEY';

export const DEFAULT_PROJECT_CHAPTER = 'DEFAULT_PROJECT_CHAPTER';

export const DEFAULT_ONE_NAV_DATA = 'DEFAULT_ONE_NAV_DATA';
